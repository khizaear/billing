...
if(form('but3')!=''){
	...
	$id=$con->insert("t_purchase",$purdat);
            ...
            <form name="form1" method="post" action="">
              ...
              <table class="table table-striped table-bordered">
                ...
                <tr>
                  ...
                  <td><input type="text" name="bill" class="form-control" required></td>
                  <td><div class="input-group">
																	<input name="date" type="text" class="form-control date-picker" id="id-date-picker-1" data-date-format="dd-mm-yyyy">
             ...
             <table class="table table-condensed table-striped" width="100%"   id="addprods">
                  ...
                  <tr  id="tr0">
                    <td valign="top"><input style="width:100%"    type="text"  autocomplete="off" class="prod form-control"  name="data[product][0][ppr_pro_id]" required  list="prods" title="0"  />
                      <datalist id="prods">
                        <?php	
                    ...
                    <td valign="top"><input name="data[product][0][ppr_amt]" type="text" required class="form-control" id="price0" size="20" /></td>
                    <td valign="top"><input type="text" class="qty form-control"  name="data[product][0][qty]" required  id="qty" onblur="gettot(0,this.value)" /></td>
                    <td><input  class="prtot form-control"  onblur="tot()"  type="text" name="data[product][0][prtot]"    required="required" id="tot0" /></td>
                    <td>&nbsp;</td>
                  </tr>
              </table>
