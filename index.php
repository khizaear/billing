						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
                                    ...
                                    <thead>	
                                    	<tr>
                                        	<th>#</th><th>Code</th><th>Name</th><th>Specifications</th><th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<?php
										...
										foreach($data as $prod){
											...
											<td>".$prod['Product']['spec']."</td>
											<td><a class='btn btn-xs btn-primary ' href='#'><i class='icon-edit'></i>Edit</a></td>
											</tr>";
											$i++;
										}
										?>
