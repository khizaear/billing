...
class GsgumaMail {
  ...
  public function setSubject($value){ $this->_subject = utf8_encode($value);        } //Subject
  ...
  */
  public function sendMail(){
    ...
    $from    = "Support <support@ilvazhkai.com>";
    ...
    ( <a href='http://www.$domain' title='Click to access the website'>http://www.$domain</a> )</body></html>";
