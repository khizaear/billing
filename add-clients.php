...
if(form('but3')!=''){
	$clients=$_POST['data'];
	$id=$con->insert('t_clients',$clients);
								...
								<form name="form1" method="post" action="">
								  ...
								  <table width="10%" class="table table-bordered table-striped table-condensed" id="table1">
								    <thead>
								      <tr>
								        <th width="30%">Name</th>
								        <td width="70%"><input class="form-control" required type="text" name="data[cli_name]" id="data[Product][code]"></td>
								      ...
								      <tr>
								        <th>Address</th>
								        <td><input class="form-control" required type="text" name="data[cli_address]" id="data[cli_address]"></td>
								        
								        </tr>
								      <tr>
								        <th>Email</th>
								        <td><input type="text"  class="form-control" name="data[cli_email]" id="data[cli_email]"></td>
								        
								        </tr>
								      <tr>
								        <th>Phone</th>
								        <td><input type="text"  class="form-control" name="data[cli_phone]" id="data[cli_phone]"></td>
								        </tr>
